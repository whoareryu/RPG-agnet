...
from core.rules.constants import ODDS_COLLAPSE_STEP, REPLAN_MAX_CONSECUTIVE
...
def mark_replanned(state: ReplanState, odds_value: float, plan: Plan | None) -> bool:
