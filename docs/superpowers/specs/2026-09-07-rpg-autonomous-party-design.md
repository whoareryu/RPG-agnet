...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **가렛 발렌** (Garret) | 중갑 전사 | +20 | +30 | +40 | +30 | ESTJ | 188cm · 건장 · 96kg | 전사 | 폐광 경비대 출신. 방패 뒤에서 세상을 본다 |
| 2 | **일레인 모어** (Elaine) | 희생형 | +10 | +70 | -10 | +80 | ENFJ | 166cm · 보통 · 58kg | 성직자(치유) | 무너진 수도원의 마지막 수련 수녀. 남을 위해 서는 것이 습관이다 |
| 3 | **카일 브란트** (Kyle) | 가장형 | -30 | +20 | +20 | -40 | ISFJ | 175cm · 보통 · 72kg | 궁수 | 두 살 딸이 있다. 위험이 오면 먼저 집을 생각한다 |
| 4 | **세라핀 뒤부아** (Seraphine) | 수읽기형 | +40 | -20 | +80 | 0 | INTJ | 171cm · 마른 · 54kg | 마법사 | 왕립 학당에서 쫓겨난 학자. 지혜가 높아 전장을 전부 본다 |
...
기획서는 "전사·마법사·궁수·도적 정도"라 했다. 힐러 없는 조합(E1 "힐러 없음")이 실험 대상이므로 **성직자**를 추가해 5종으로 한다. 성직자가 없으면 "힐러 없음" 조합이 성립하지 않는다.

| 클래스 | 주 능력치 | 이상 신체 | 무기 후보(AI 세부 층이 고름) | 기본 스킬 |
|---|---|---|---|---|
| 전사 | 힘·체력 | 건장, 키 175+ | 방패+검(탱커) / 워해머(단신 고힘) / 쌍검(마른 고민첩) | 방패 밀치기(전열 보호), 강타 |
| 마법사 | 지능 | 마른·보통 | 지팡이 / 마도서 | 화염구(범위), 서리 결계(적 속도 감소) |
| 궁수 | 민첩 | 마른·보통, 키 165+ | 장궁(키 큼) / 단궁 / 석궁(힘 높음) | 조준 사격(후열 저격), 연사 |
| 도적 | 민첩·행운 | 마른, 60kg 이하 | 단검 / 투척 나이프 | 급소 찌르기(치명), 연막(적 명중 감소) |
| 성직자 | 지혜·지능 | 제한 없음 | 철퇴 / 성표 | 치유, 축복(아군 명중 상승) |
