...
const SCENES = [
  {
    kicker: "장면 1 · 이탈",
    title: "약탈병이 먼저 물러섰다",
    body: "두 살 딸이 집에 있는 아녜스는 HP 가 무너지면 중대장의 방침을 버린다. 왜? 클릭하면 열린다 — 이탈 확률, 위험 성향 -40, 희생 수용도 -50 이 항목별로 남는다.",
    tag: "판정 인스펙터",
  },
  {
    kicker: "장면 2 · 포기",
    ...
    <main className="page page-narrow stack" style={{ gap: 28 }}>
      <section className="stack" style={{ gap: 12, paddingTop: 12 }}>
        ...
        <p className="muted" style={{ fontSize: 16 }}>
          ...
          중대장 AI 가 작전을 짜고 단원 AI 가 매 턴 판단한다. 그리고 <b>왜 그랬는지</b> 전부 숫자로 남는다.
        </p>
